...
<div class="flex flex-col sm:flex-row gap-2 mb-6">
  <div class="join sm:flex-1">
    <div id="dropdown-activites" class="dropdown join-item">
      <div tabindex="0" role="button" id="dropdown-activites-btn" class="btn join-item rounded-r-none lg:w-48">
        <span class="hidden lg:block">Toutes les activites</span>
      ...
      <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-10 w-52 p-2 shadow-sm">
        <li><a data-value="all" aria-selected="true">Toutes les activites</a></li>
