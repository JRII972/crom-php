...
<div class="card bg-base-200 shadow-xl overflow-hidden" id="activite-card-info">
  ...
  <figure class="relative">
    ...
    <div class="absolute top-3 right-3">
      <div class="badge badge-lg" id="activite-type-badge">{{ $activite->getTypeFormatted() }}</div>
    </div>
  ...
  <div class="card-body">
    ...
    <div class="flex items-center gap-3 mb-4">
      <div class="avatar">
        <div class="w-10 rounded-full">
          <img src="{{ $activite->getMaitreJeu()->getImageURL() }}" alt="Avatar du MJ" />
        </div>
      </div>
      <div>
        <p class="text-sm opacity-70">Maître du jeu</p>
        <p class="font-medium" id="activite-mj">{{ $activite->getMaitreJeu()->getNom() }} <span class="text-sm opacity-70">{{ $activite->getMaitreJeu()->getPseudonyme() }}</span></p>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-2">
        ...
        <span id="activite-lieu">{{ $activite->getLieu() }}</span>
      </div>
